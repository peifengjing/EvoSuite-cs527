...
public class TutByOAuthServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.scribejava.apis.service.TutByOAuthServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TutByOAuthServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.github.scribejava.core.builder.api.DefaultApi20", false, TutByOAuthServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.github.scribejava.core.model.OAuthConfig", false, TutByOAuthServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.github.scribejava.core.model.OAuthRequest", false, TutByOAuthServiceImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TutByOAuthServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
