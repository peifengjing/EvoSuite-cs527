...
public class FacebookAccessTokenJsonExtractor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.scribejava.apis.facebook.FacebookAccessTokenJsonExtractor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FacebookAccessTokenJsonExtractor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FacebookAccessTokenJsonExtractor_ESTest_scaffolding.class.getClassLoader()); 
