...
public class MailruExample_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.scribejava.apis.examples.MailruExample"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MailruExample_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.github.scribejava.apis.examples.MailruExample"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MailruExample_ESTest_scaffolding.class.getClassLoader()); 
