...
public class TrelloExample_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.scribejava.apis.examples.TrelloExample"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TrelloExample_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.github.scribejava.apis.examples.TrelloExample",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TrelloExample_ESTest_scaffolding.class.getClassLoader()); 
