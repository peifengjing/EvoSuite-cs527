...
public class OdnoklassnikiServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.scribejava.apis.service.OdnoklassnikiServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OdnoklassnikiServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.github.scribejava.core.builder.api.DefaultApi20", false, OdnoklassnikiServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.github.scribejava.core.model.OAuthConfig", false, OdnoklassnikiServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.github.scribejava.core.model.OAuthRequest", false, OdnoklassnikiServiceImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OdnoklassnikiServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
