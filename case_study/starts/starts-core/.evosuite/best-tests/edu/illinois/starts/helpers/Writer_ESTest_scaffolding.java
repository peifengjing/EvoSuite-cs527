...
public class Writer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "edu.illinois.starts.helpers.Writer"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.illinois.yasgl.GraphVertexVisitor", false, Writer_ESTest_scaffolding.class.getClassLoader()));
  }
