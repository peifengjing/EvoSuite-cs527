...
public class ErrorPageController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.springside.examples.bootapi.api.support.ErrorPageController"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ErrorPageController_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.springside.examples.bootapi.api.support.ErrorPageController",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, ErrorPageController_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ErrorPageController_ESTest_scaffolding.class.getClassLoader()); 
