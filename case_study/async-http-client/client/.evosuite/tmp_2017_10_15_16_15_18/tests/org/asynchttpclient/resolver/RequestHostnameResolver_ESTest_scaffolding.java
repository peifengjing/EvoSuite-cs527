...
public class RequestHostnameResolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.asynchttpclient.resolver.RequestHostnameResolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RequestHostnameResolver_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.netty.resolver.NameResolver", false, RequestHostnameResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.asynchttpclient.handler.AsyncHandlerExtensions", false, RequestHostnameResolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RequestHostnameResolver_ESTest_scaffolding.class.getClassLoader()); 
