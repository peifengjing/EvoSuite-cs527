...
public class BodyChunkedInput_ESTest extends BodyChunkedInput_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn((ByteBufAllocator) null).when(channelHandlerContext0).alloc();
      try { 
        ...
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("org.asynchttpclient.netty.request.body.BodyChunkedInput", e);
      }
  }
  ...
  public void test01()  throws Throwable  {
      ...
      PushBody pushBody0 = new PushBody(priorityQueue0);
      BodyChunkedInput bodyChunkedInput0 = new BodyChunkedInput(pushBody0);
      PooledByteBufAllocator pooledByteBufAllocator0 = new PooledByteBufAllocator(1, 1, 8192, (-9999));
      ChannelHandlerContext channelHandlerContext0 = mock(ChannelHandlerContext.class, new ViolatedAssumptionAnswer());
  ...
  public void test02()  throws Throwable  {
      ...
      BodyChunkedInput bodyChunkedInput0 = new BodyChunkedInput(pushBody0);
      try { 
        bodyChunkedInput0.readChunk((ByteBufAllocator) null);
        fail("Expecting exception: NullPointerException");
