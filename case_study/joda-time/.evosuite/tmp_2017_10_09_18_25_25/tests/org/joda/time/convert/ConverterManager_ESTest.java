...
public class ConverterManager_ESTest extends ConverterManager_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        converterManager0.getInstantConverter(stringConverter0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No instant converter found for type: org.joda.time.convert.StringConverter
         //
  ...
  public void test01()  throws Throwable  {
      ...
      assertSame(readableIntervalConverter0, intervalConverter0);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      PeriodConverter periodConverter0 = converterManager0.addPeriodConverter(nullConverter0);
      assertNotSame(nullConverter0, periodConverter0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        converterManager0.getIntervalConverter(readablePartialConverter0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No interval converter found for type: org.joda.time.convert.ReadablePartialConverter
         //
         verifyException("org.joda.time.convert.ConverterManager", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      NullConverter nullConverter1 = (NullConverter)converterManager0.removePeriodConverter(nullConverter0);
      assertSame(nullConverter1, nullConverter0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        converterManager0.getPeriodConverter(longConverter0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No period converter found for type: org.joda.time.convert.LongConverter
         //
         verifyException("org.joda.time.convert.ConverterManager", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      DurationConverter durationConverter0 = converterManager0.removeDurationConverter(nullConverter0);
      assertSame(durationConverter0, nullConverter0);
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertNotSame(readableDurationConverter0, durationConverter0);
  }
  ...
  public void test18()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        converterManager0.getDurationConverter(mockHijrahDate0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      assertNotSame(stringConverter0, partialConverter0);
  }
  ...
  public void test22()  throws Throwable  {
      ...
      try {
        localDateTime0 = new LocalDateTime((Object) null, lenientChronology0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      InstantConverter instantConverter0 = converterManager0.removeInstantConverter(readableInstantConverter0);
      assertSame(readableInstantConverter0, instantConverter0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      assertNotSame(instantConverter0, nullConverter0);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        converterManager0.getPartialConverter(instantConverter0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // No partial converter found for type: org.joda.time.convert.NullConverter
         //
         verifyException("org.joda.time.convert.ConverterManager", e);
      }
  }
